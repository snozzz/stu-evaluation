  ...
  <div class="admin-layout">
    ...
    <div class="sidebar">
      <div class="logo-area">
        ...
        <span class="logo-text">{{ systemName || '学评系统' }}</span>
      </div>
      <el-menu
      ...
      >
        ...
        <el-menu-item index="/admin/dimensions">
          <i class="el-icon-set-up"></i>
          <span slot="title">评价维度</span>
        </el-menu-item>
        <el-menu-item index="/admin/weights">
          <i class="el-icon-scale-to-original"></i>
          <span slot="title">权重配置</span>
        </el-menu-item>
...
export default {
  ...
  computed: {
    ...
    userName() {
      return this.userInfo.realName || this.userInfo.nickname || '管理员'
    },
    avatarText() {
    ...
    breadcrumbList() {
      ...
      const list = [{ name: '首页', path: '/admin/dashboard' }]
...
.admin-layout .sidebar:has(~ .main-area .collapse-btn.el-icon-s-unfold) {
  width: 64px;
  min-width: 64px;
}
