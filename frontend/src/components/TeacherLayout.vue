    ...
    <div class="sidebar" :class="{ collapsed: isCollapse }">
      <div class="logo-area">
        <div class="logo-icon">
          ...
          <i v-else class="el-icon-s-check"></i>
        </div>
      ...
      >
        <el-menu-item index="/teacher/dashboard">
          ...
          <span slot="title">教学概览</span>
        </el-menu-item>
        <el-menu-item index="/teacher/bindCourse">
          <i class="el-icon-connection"></i>
          <span slot="title">课程绑定</span>
        </el-menu-item>
        <el-menu-item index="/teacher/scores">
          <i class="el-icon-document-checked"></i>
          <span slot="title">成绩评价</span>
        </el-menu-item>
        <el-menu-item index="/teacher/comments">
          <i class="el-icon-chat-line-round"></i>
          <span slot="title">评语管理</span>
        </el-menu-item>
...
export default {
  ...
  computed: {
    ...
    userName() {
      return this.userInfo.realName || this.userInfo.username || '教师'
    },
    avatarText() {
    ...
    breadcrumbList() {
      ...
      const list = [{ name: '首页', path: '/teacher/dashboard' }]
